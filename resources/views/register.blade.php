    ...
    <div class="container col-md-6 p-3 my-3">
        <div class="row justify-content-center">
            <div class="form-container bg-light p-3 my-3 needs-validation justify-content-center">
                <form action="" class="">
                    <h3 class="text-center text-uppercase py-3">Đăng ký tài khoản</h3>
                    ...
                    <div class="input-group mb-3">
                        ...
                        <div class="input-group mb-3">
                            <label for="repassword">Đã có tài khoản? <a style="text-decoration: none;"
                                    href="/login">Đăng nhập tại đây
                                    !</a></label>
                        </div>
                        <div class="input-group mb-3">
                            <div class="form-floating">
                                <input type="submit" class="btn btn-primary" id="floatingInput" value="Đăng ký">
                            </div>
                        </div>
                    </div>
                </form>
